...
export const appRoutes: Route[] = [
    ...
    // {path: 'show-candidate', pathMatch : 'full', redirectTo: 'showCandidateComponent'},
    ...
    // Admin routes
    {
        ...
        children   : [
            ...
            // {path: 'candidateform', loadChildren: () => import('app/modules/admin/candidate-form/candidate-form.module').then(m => m.CandiateFormModule)},
            ...
            {
                path:"interviewer-page",
                component:InterviewerPageComponent
            },
            {
                path:"assessment-details-page",
                component:AssessmentDetailsPageComponent
            }
        ]
