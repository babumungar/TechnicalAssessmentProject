    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                } else if (request.body.email === 'hr1@gmail.com' && request.body.password === 'pass1') {
                    return [
                        200,
                        {
                            user       : cloneDeep(this._user),
                ...
                } else if (request.body.email === 'hr2@gmail.com' && request.body.password === 'pass1') {
                    return [
                        200,
                        {
                            user       : cloneDeep(this._user),
                ...
                }  else if (request.body.email === 'hr3@gmail.com' && request.body.password === 'pass1') {
                    return [
                        200,
                        {
                            user       : cloneDeep(this._user),
                ...
                } else if (request.body.email === 'interviewer1@gmail.com' && request.body.password === 'pass1') {
                    return [
                        200,
                        {
                            user       : cloneDeep(this._user),
                ...
                } else if (request.body.email === 'interviewer2@gmail.com' && request.body.password === 'pass1') {
                    return [
                        200,
                        {
                            user       : cloneDeep(this._user),
                ...
                } else if (request.body.email === 'interviewer3@gmail.com' && request.body.password === 'pass1') {
                    return [
                        200,
                        {
                            user       : cloneDeep(this._user),
